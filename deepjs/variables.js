...
worldmap.push(new Chunk(0,0));
worldmap[1].tile[0][0] = herezone;
///let chunk = [],[],[];
///chunk[0,0,0] = herezone;
//worldmap.push(herezone);
mapborderx = 0;
mapbordery = 0;
mapcenterx = 0;
mapcentery = 0;
...
stocks.push(new Stonk(1006, "watermelon", 5, "kg", "KFC AN WATERMELONS. Yeah, watermelon are berry too."));
